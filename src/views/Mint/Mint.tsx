        ...
        {!!account ? (
          <>
            <Route exact path={path}>
              <PageHeader icon={'🏦'} title="MINT" subtitle="Mint FTM to FTMX" />
            </Route>
            <Box mt={5}>
                        ...
                        <CardContent>
                          <StyledCardContentInner>
                            {/* <StyledCardContentHeader>
                              <StyledCardTitle>FTM</StyledCardTitle>
                            ...
                            <Grid item xs={12}>
                              <TokenInput
                                ...
                                max={bondBalance}
                                symbol="TBond"
                                icon={<TokenSymbol symbol={tombFinance.TBOND.symbol} size={54} />}
                              ></TokenInput>
                            </Grid>
                          </StyledCardContentInner>
                          ...
                          <StyledCardContentInner>
                            {/* <StyledCardTitle>FTMX</StyledCardTitle>
                            <StyledExchanger>
                              <StyledToken>
                                <StyledCardIcon>
                                  <TokenSymbol symbol={tombFinance.FTMX.symbol} size={54} />
                                </StyledCardIcon>
                              </StyledToken>
                            </StyledExchanger> */}
                            <Grid item xs={12}>
                              <TokenInput
                                ...
                                max={tshareBalance}
                                symbol="TShare"
                                icon={<TokenSymbol symbol={tombFinance.FTMX.symbol} size={54} />}
                              ></TokenInput>
                            </Grid>
