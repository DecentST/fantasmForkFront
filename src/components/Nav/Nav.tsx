        ...
        {matches ? (
          <>
            ...
            <Box mr={5}>
              ...
              <Link color="textPrimary" to="/mint" className={classes.link}>
                Mint
              </Link>
              <Link color="textPrimary" to="/redeem" className={classes.link}>
                Redeem
              </Link>
          ...
          <>
            ...
            >
              ...
              <List>
                ...
                <ListItemLink primary="Redeem" to="/redeem" />
                <ListItemLink primary="Farms" to="/farms" />
                <ListItemLink primary="Staking" to="/staking" />
                {/* <ListItemLink primary="Liquidity" to="/liquidity" />
                <ListItemLink primary="Regulations" to="/regulations" /> */}
                <ListItem button component="a" href="https://docs.tiktok.ch">
